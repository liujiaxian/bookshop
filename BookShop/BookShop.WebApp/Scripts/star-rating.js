...
(function ($) {
    ...
    $.fn.rating.defaults = {
        ...
        showClear: true,
        showCaption: true,
        defaultCaption: '{rating} 个星',
        starCaptions: {
            0.5: '<span class="ratingcount">0.5</span> 个星',
            1: '<span class="ratingcount">1</span> 个星',
            1.5: '<span class="ratingcount">1.5</span> 个星',
            2: '<span class="ratingcount">2</span> 个星',
            2.5: '<span class="ratingcount">2.5</span> 个星',
            3: '<span class="ratingcount">3</span> 个星',
            3.5: '<span class="ratingcount">3.5</span> 个星',
            4: '<span class="ratingcount">4</span> 个星',
            4.5: '<span class="ratingcount">4.5</span> 个星',
            5: '<span class="ratingcount">5</span> 个星'
        },
        starCaptionClasses: {
